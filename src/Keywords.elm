...
keywordReplacements =
    [ ( "all", "∀" ), ( "ex", "∃" ), ( "and", "∧" ), ( "conj", "∧" ), ( "or", "∨" ), ( "disj", "∨" ), ( "imp", "⟶" ), ( "bot", "⊥" ), ( "top", "⊤" ), ( "not", "¬" ), ( "neg", "¬" ), ( "iff", "⟷" ), ( "seq", "⊢" ), ( "eq", "＝" ) ]
...
greekLetterReplacementsLower =
    [ ( "alpha", "α" ), ( "beta", "β" ), ( "gamma", "γ" ), ( "delta", "δ" ), ( "eps", "ϵ" ), ( "zeta", "ζ" ), ( "theta", "θ" ), ( "eta", "η" ), ( "ioata", "ι" ), ( "kappa", "κ" ), ( "lambda", "λ" ), ( "mu", "μ" ), ( "nu", "ν" ), ( "xi", "ξ" ), ( "omicron", "o" ), ( "pi", "π" ), ( "rho", "ρ" ), ( "sigma", "σ" ), ( "tau", "τ" ), ( "ups", "υ" ), ( "phi", "ϕ" ), ( "chi", "χ" ), ( "psi", "ψ" ), ( "omega", "ω" ) ]


greekLetterReplacementsUpper : List ( String, String )
greekLetterReplacementsUpper =
    [ ( "Alpha", "A" ), ( "Bet", "B" ), ( "Gamma", "Γ" ), ( "Delta", "Δ" ), ( "Eps", "E" ), ( "Zeta", "Z" ), ( "Eta", "H" ), ( "Theta", "Θ" ), ( "Ioata", "I" ), ( "Kappa", "K" ), ( "Lambda", "Λ" ), ( "Mu", "M" ), ( "Nu", "N" ), ( "Xi", "Ξ" ), ( "Omicron", "O" ), ( "Pi", "Π" ), ( "Rho", "P" ), ( "Sigma", "Σ" ), ( "Tau", "T" ), ( "Ups", "ϒ" ), ( "Phi", "Φ" ), ( "Chi", "X" ), ( "Psi", "Ψ" ), ( "Omega", "Ω" ) ]
